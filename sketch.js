...
function setup() {
  ...
  dog = createSprite(300,580,10,10);
  ...
  input.position(500,120);

  button = createButton("Confirm");
  button.position(600,145);
...
function draw() { 
  ...
  textSize(20);
  text("Last fed: "+lastFed+":00",150,310);
  //text("Press the up arrow key to feed the dog!",width/2-200,100);
  text("Time since last fed: "+(currentTime - lastFed),150,340);
}
